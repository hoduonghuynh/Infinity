...
namespace Ketnoimaytinh
{
    public partial class Form1 : System.Windows.Forms.Form
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Chưa lưu trữ ảnh của chó.", "Thông báo");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
          ...
          string sqlGhi = "INSERT INTO Data VALUES (@UID,@TenChu,@TenCho,@SDT,@CanNang,@SoLanTiem,@Ngaytiemcuoi,@TenThuoc)";
          SqlCommand cmd = new SqlCommand(sqlGhi, con);
          cmd.Parameters.AddWithValue("UID", UID);
          cmd.Parameters.AddWithValue("TenChu", txtName.Text);
          cmd.Parameters.AddWithValue("TenCho", txtDogName.Text);
          cmd.Parameters.AddWithValue("SDT", txtPhone.Text);
          string sl = "2";
          cmd.Parameters.AddWithValue("SoLanTiem", sl);
          cmd.Parameters.AddWithValue("CanNang", txtWeight.Text);
          string vacdate = VacDay + VacMonth + VacYear;
          cmd.Parameters.AddWithValue("Ngaytiemcuoi", vacdate);
          cmd.Parameters.AddWithValue("TenThuoc", comboBoxVaccine.Text);
          cmd.ExecuteNonQuery();
        }
